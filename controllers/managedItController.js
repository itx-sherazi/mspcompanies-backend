  ...
  try {
    ...
    const [total, companies] = await Promise.all([
      ...
      ManagedItCompany.find(filter)
        ...
        .skip(skip)
        .limit(limit)
        .select("slug companyName employees industry website companyCity companyState companyCountry phone description image companyServices companyPartners foundedYear linkedinUrl facebookUrl twitterUrl")
        .lean(),
    ]);
